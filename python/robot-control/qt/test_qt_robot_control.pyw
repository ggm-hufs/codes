...
class genAppQt4(QMainWindow):
    command_string = '' #Main command string to send over bluetooth.
    def __init__(self, parent=None):
        super(genAppQt4, self).__init__(parent)
        self.resize(705, 300)
        self.setWindowTitle("Robot Control Graphical Interface (Qt4)")
        self.center() #Centers the window.
        self.grid = QGridLayout()
        
        #App main layout:
        self.monitorTitleLabel = QLabel("Robot Monitor")
        self.grid.addWidget(self.monitorTitleLabel, 0, 0)
